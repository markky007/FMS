<template>
  <q-footer elevated class="bg-white text-grey-8 border-top">
    ...
    >
      <q-route-tab name="home" to="/home" icon="home" label="หน้าหลัก" exact />
    ...
    >
      <q-card class="mobile-menu-sheet">
        ...
        <q-card-section
          class="q-pt-none q-pb-sm row items-center justify-between"
        >
          <div>
            <div
            ...
            <div class="text-caption text-grey-7"
              >เลือกรายการที่ต้องการทำรายการบนมือถือ</div
            >
          </div>
          ...
          <div class="row q-col-gutter-sm">
            ...
            <template v-if="authStore.isAdmin">
              <div class="col-6">
                <q-card
                  flat
                  bordered
                  class="menu-action-card bg-blue-1 border-blue cursor-pointer"
              ...
              <div class="col-6">
                <q-card
                  flat
                  bordered
                  class="menu-action-card bg-indigo-1 border-indigo cursor-pointer"
                ...
                >
                  <q-card-section class="q-pa-sm text-center">
                    ...
                    <div class="text-weight-bold text-caption text-indigo-9"
                      >จัดการสาขา/แผนก</div
                    >
                    <div
                      class="text-caption text-grey-7"
            ...
            <template v-if="authStore.isManagerOrAdmin">
              <div class="col-6">
                <q-card
                  flat
                  bordered
                  class="menu-action-card bg-amber-1 border-amber cursor-pointer"
                ...
                >
                  <q-card-section class="q-pa-sm text-center">
                    ...
                    <div class="text-weight-bold text-caption text-amber-10"
                      >รายงานสรุป</div
                    >
                    <div
                      class="text-caption text-grey-7"
                      style="font-size: 0.68rem"
                      >รายงานและการวิเคราะห์</div
                    >
                  </q-card-section>
                </q-card>
              </div>
            ...
            <div class="col-6">
              <q-card
                flat
                bordered
                class="menu-action-card bg-teal-1 border-teal cursor-pointer"
                @click="navigate('/delivery')"
              >
                <q-card-section class="q-pa-sm text-center">
                  <q-avatar
                    size="38px"
                  ...
                  <div class="text-weight-bold text-caption text-teal-10"
                    >ใบส่งของฉัน</div
                  >
                  <div
                    class="text-caption text-grey-7"
                    style="font-size: 0.68rem"
                    >รายการส่งเอกสารทั้งหมด</div
                  >
                </q-card-section>
              </q-card>
            </div>
            ...
            <div class="col-6">
              <q-card
                flat
                bordered
                class="menu-action-card bg-emerald-1 border-emerald cursor-pointer"
                @click="navigate('/receiving/history')"
              >
                <q-card-section class="q-pa-sm text-center">
                  <q-avatar
                    size="38px"
                  ...
                  <div
                    class="text-weight-bold text-caption text-emerald-9"
                    style="color: #047857"
                    >ประวัติการรับ</div
                  >
                  <div
            ...
            <div class="col-6">
              <q-card
                flat
                bordered
                class="menu-action-card bg-slate-1 border-slate cursor-pointer"
              ...
              >
                <q-card-section class="q-pa-sm text-center">
                  ...
                  <div
                    class="text-weight-bold text-caption text-slate-9"
                    style="color: #1e293b"
                    >โปรไฟล์ / ตั้งค่า</div
                  >
                  <div
